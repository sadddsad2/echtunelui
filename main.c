...
void SaveConfigToFile() {
    OPENFILENAME ofn;
    char fileName[MAX_PATH] = "config.ini";
    ...
    char msg[512];
    snprintf(msg, sizeof(msg), "配置已保存到:\n%s", fileName);
